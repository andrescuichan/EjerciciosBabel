...
var notas_asignatura : number[] = [6,3,4,5,6]
...
function nota_final(notas: number[]): number {
...
console.log("\n--------------Apartado 2--------------\n")
var videojuegos : string[] = ["La comunidad del anillo", "mario kart", "El retorno del rey", "Las dos torres", "LOL", "Super mario bros"]
console.log("Videojuegos con mario: " + videojuegos)

function eliminar_mario(games: string[]): string[]{
    let videojuegosSinMario : string[] = []
...
function operacion_factorial(numeroFactorial: number): number{
